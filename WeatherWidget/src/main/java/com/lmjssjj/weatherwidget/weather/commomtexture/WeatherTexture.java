...
public class WeatherTexture extends GLImage {

    public static float scaling = 0.73f;
    ...
    public WeatherTexture(Context context, int resId) {
        super(context, resId, vertex_position_xyz, vertex_content_st);
    }

    public WeatherTexture(Bitmap bitmap) {
